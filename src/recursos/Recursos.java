...
public class Recursos {
    ...
    //Esta funcion aumenta el tamaño de FILAS en 1 cada vez que se añade una serie de datos nuevos, el array dato[] debe ser igual al numero de COLUMNAS de array[][].
